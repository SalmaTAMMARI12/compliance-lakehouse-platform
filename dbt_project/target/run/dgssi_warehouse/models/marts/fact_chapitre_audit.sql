  ...
  create  table "dgssi"."public_marts"."fact_chapitre_audit__dbt_tmp"
...
select
    ...
    c.nom_chapitre,
    c.clauses
from "dgssi"."public_staging"."stg_chapitres" c
left join "dgssi"."public_marts"."dim_chapitre_dnssi" d
